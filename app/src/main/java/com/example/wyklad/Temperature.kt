...
object SharedData {
    var temperature = 0.toFloat()
}
class Temperature : AppCompatActivity(),SensorEventListener {
...
//    }
    ...
    mTmp = mSensorManager.getDefaultSensor(Sensor.TYPE_AMBIENT_TEMPERATURE)
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        if (event?.sensor?.type == Sensor.TYPE_AMBIENT_TEMPERATURE) {
            tmp.text = value.toString().plus(" stopni Celsjusza");
